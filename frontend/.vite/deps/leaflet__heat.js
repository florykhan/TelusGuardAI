...
(function() {
	...
	t.prototype = {
		...
		data: function(t$1, i) {
			return this._data = t$1, this;
		},
		max: function(t$1) {
			return this._max = t$1, this;
		},
		add: function(t$1) {
			return this._data.push(t$1), this;
		},
		clear: function() {
			return this._data = [], this;
		},
		radius: function(t$1, i) {
			i = i || 15;
			var a = this._circle = document.createElement("canvas"), s = a.getContext("2d"), e = this._r = t$1 + i;
			return a.width = a.height = 2 * e, s.shadowOffsetX = s.shadowOffsetY = 200, s.shadowBlur = i, s.shadowColor = "black", s.beginPath(), s.arc(e - 200, e - 200, t$1, 0, 2 * Math.PI, !0), s.closePath(), s.fill(), this;
		},
		gradient: function(t$1) {
			var i = document.createElement("canvas"), a = i.getContext("2d"), s = a.createLinearGradient(0, 0, 0, 256);
			i.width = 1, i.height = 256;
			for (var e in t$1) s.addColorStop(e, t$1[e]);
		...
		draw: function(t$1) {
			...
			for (var a, s = 0, e = this._data.length; e > s; s++) a = this._data[s], i.globalAlpha = Math.max(a[2] / this._max, t$1 || .05), i.drawImage(this._circle, a[0] - this._r, a[1] - this._r);
			var n = i.getImageData(0, 0, this._width, this._height);
			return this._colorize(n.data, this._grad), i.putImageData(n, 0, 0), this;
		},
		_colorize: function(t$1, i) {
			for (var a, s = 3, e = t$1.length; e > s; s += 4) a = 4 * t$1[s], a && (t$1[s - 3] = i[a], t$1[s - 2] = i[a + 1], t$1[s - 1] = i[a + 2]);
		}
	}, window.simpleheat = t;
