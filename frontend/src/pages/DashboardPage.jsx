...
export default function DashboardPage({
  ...
  const kpiById = Object.fromEntries(
    towers.filter((t) => !!t.kpi).map((t) => [t.id, t.kpi])
  );
    ...
    <div className="noc-shell">
      <div className="noc-grid">
        ...
        <div className="noc-col noc-center">
          <div className="noc-col-inner">
            <div className="noc-section" style={{ display: "flex", gap: 12, alignItems: "center" }}>
            ...
            <div style={{ padding: 12, height: "100%" }}>
              <div style={{ height: "calc(100vh - 96px)", borderRadius: 12, overflow: "hidden" }}>
                <CoverageMap
                  towers={towers}
                  center={center}
                  zoom={4}
